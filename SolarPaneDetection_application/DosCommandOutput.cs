...
namespace SolarPaneDetection_application
{
    ...
    class DosCommandOutput
    {
        ...
        public static string Execute(string exe,string dosCommand)
        {
            return Execute(exe,dosCommand, 60 * 1000);
        }
        /// <summary>
        /// 执行DOS命令，返回DOS命令的输出
        /// </summary>
        ...
        /// <returns>返回输出，如果发生异常，返回空字符串</returns>
        public static string Execute(string exe,string dosCommand, int milliseconds)
        {
            string output = "";     //输出字符串
